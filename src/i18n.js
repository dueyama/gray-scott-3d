...
const translations = {
  en: {
    ...
    "compute.cpu": "CPU",
    "compute.gpgpu": "GPGPU",
    "compute.note": "GPGPU is tried first; CPU is used when unavailable. Switching restarts from the same seed and parameters.",
    "control.feed": "F (feed)",
    "control.kill": "k (kill)",
  ...
  jp: {
    ...
    "compute.cpu": "CPU",
    "compute.gpgpu": "GPGPU",
    "compute.note": "最初に GPGPU を試し、使えない場合は CPU に戻します。切り替えると同じ seed とパラメータで再計算します。",
    "control.feed": "F（供給率）",
    "control.kill": "k（除去率）",
